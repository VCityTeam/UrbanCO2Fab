...
def get_transactions(repository, version1, version2, start_time="",
  ...
  if (commit is not None):
   ...
   for entry in tree:
     ...
     if(".xml" in entry.name or ".gml" in entry.name):
        ...
        #print(blob.read_raw().decode('utf-8'))
        #exit(1)
  ...
  print("value: " + str(featuresv1["PolyID5909_195_534319_413692_0"]))
  print("value: " + str(featuresv2["PolyID5909_195_534319_413692_0"]))

  print("value: " + str(featuresv1["GMLID_BUI367978_1828_268"]))
  print("value: " + str(featuresv2["GMLID_BUI367978_1828_268"]))
          ...
          if graph is not None:
            for edge in graph.edges:
              ...
              if (gmlid==graph.nodes[int(edge.target)].globalid[6:] and
                ...
                for feature in datav2[change][newgmlid]:
                   attribute = next(iter(datav2[change][newgmlid][feature].keys()))
