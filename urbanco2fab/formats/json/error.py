...
class AbstractFeatureError(Exception):
  """Abstract feature Error"""
  def __init__(self, message):
    self.message = "Error in creating abstract feature" + message


class TransactionError(Exception):
  """Version Error"""
  def __init__(self, message):
    self.message = "Error in creating transcation: " + message
